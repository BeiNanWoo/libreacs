...
public class HostsBean extends JsfBeanBase implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1332393079495277288L;
...
//            Iterator cfgs = Ejb.lookupConfigurationBean().findAll().iterator();
    ...
    public Collection<HostsLocal> getFindResult() {
        return findResult;
    }
...
//        System.out.print("getFindResultLength = " + r);
	...
	private HardwareModelLocal model;
...
//            h = Ejb.lookupHostsBean().findByPrimaryKey(new HostsPK(ouiIn, snIn));
	...
	public String findItems() {
		...
		try {
			// h = Ejb.lookupHostsBean().findByPrimaryKey(new HostsPK(ouiIn,
			// snIn));
			// System.out.println ("findItemBySn");findByPartSerial
			// findResult = Ejb.lookupHostsBean().findBySerialno(snIn);
			findResult = Ejb.lookupHostsBean().findByPartSerial(snIn);

			System.out.println("Found " + findResult.size() + "items");
			 ...
			 * FacesMessage(FacesMessage.SEVERITY_ERROR, "CPE not found in DB",
			 * "Nu detales"));
			 */
			return "notfound";
		}
...
//        propname = DataModel.getNormalizedName("", propname);
	 ...
	 * @return the model
	 */
	public HardwareModelLocal getModel() {
		return model;
	}
	 ...
	 */
	public void setModel(HardwareModelLocal model) {
		this.model = model;
	}

	/**
	 * @return the lastcrres
	 */
	public String getLastcrres() {
//		System.out.println ("getLastcrres="+lastcrres);
		return lastcrres;
	}

	/**
	 * @param lastcrres the lastcrres to set
	 */
	public void setLastcrres(String lastcrres) {
//		System.out.println ("setLastcrres="+lastcrres);
