...
public abstract class HostsBean implements EntityBean, HostsLocalBusiness {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8570321165818568427L;
	/**
	 * 
	 */
    ...
    public abstract String getLastcrres();

    public abstract void setLastcrres(String lastcrres);
    ...
    public void RequestConnection(int timeout) throws Exception {
        ...
        if (url.startsWith("udp://")) {
            ...
            RequestConnectionHttp(url, user, pass, timeout);
        }
    }
